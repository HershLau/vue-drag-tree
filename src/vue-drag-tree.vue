<template>
  <div>
    <div :id='model.id' @click="toggle" draggable='true' @dragstart='dragStart'
         @dragover='dragOver' @dragenter='dragEnter' @dragleave='dragLeave' @drop='drop' @dragend='dragEnd'
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      removeChild(id) {
        let deleteFlag = this.deleteNode(id)
        if (!deleteFlag) {
          return
        }
